...
#define PARAM_CHECK(param) strncmp( pcParameter, param, strlen(param)) == 0
...
//Defines the CLI task... see FreeRTOS_CLI_Task.c
extern void vUDPCommandInterpreterTask( void *pvParameters );

//Define all the commands for the CLI.... see CLI-commands.c
extern void vRegisterCLICommands( void );

//Used for reporting back an error on the CLI.... see CLI-commands.c 
extern void reset_cntrl(uint32_t reset_reason);

extern void printBanner(uint8_t* err);
